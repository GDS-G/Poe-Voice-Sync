...
Before uploading, rasterize to 24-bit PNG, inspect the 16 px icon for legibility, and verify every image against current store dimensions. Use a real current product screenshot as the first screenshot when a store distinguishes screenshots from promotional artwork.

Discord support and feedback: https://discord.gg/YzWbrnyxus

Poe Voice Sync is an independent extension and is not affiliated with Poe/Quora, ElevenLabs, or Hume.
